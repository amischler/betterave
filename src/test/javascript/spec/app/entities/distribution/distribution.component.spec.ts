...
import { DistributionComponent } from 'app/entities/distribution/distribution.component';
...
describe('Component Tests', () => {
    describe('Distribution Management Component', () => {
        let comp: DistributionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DistributionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.distributions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
